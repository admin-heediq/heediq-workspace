...
Write-Host "  1. Configure AWS SSO profiles (see heediq-infra/README.md → AWS CLI Profiles)"
Write-Host "  2. Run AWS setup (CDK bootstrap + OIDC roles):"
Write-Host "     cd '$WorkspaceRoot\heediq-infra'; bash scripts/setup.sh"
Write-Host "     (use Git Bash for the AWS setup script — not PowerShell)"
Write-Host "  3. Start Claude from the workspace root:"
